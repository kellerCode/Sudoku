...
namespace Sudoku.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult sudoku(List<int> sec1, List<int> sec2, List<int> sec3, List<int> sec4, List<int> sec5, List<int> sec6, List<int> sec7, List<int> sec8, List<int> sec9)
        {
            ...
            { 
                TempData["Message"] = "Good Job!";
            }
            else
            {
                TempData["Message"] = "Try Again";
            }
            return RedirectToAction("Index", sec1);
        }
